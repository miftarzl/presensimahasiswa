...
<head>
    ...
    <title>Laporan - Presensi Online Mahasiswa</title>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('laporan.detail', $class->id) }}"
                                                   class="btn btn-primary btn-sm">
                                                   Detail
                                                </a>

                                                <a href="{{ route('laporan.pdf', $class->id) }}"
                                                   class="btn btn-danger btn-sm">
                                                   PDF
                                                </a>

                                                <a href="{{ route('laporan.excel', $class->id) }}"
