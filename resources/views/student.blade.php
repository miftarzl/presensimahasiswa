...
<div class="modal fade" id="addStudent">
  <div class="modal-dialog">
    @if($class)
    <form action="{{ route('student.add', $class->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
						...
						<div class="row">
							...
							<div class="col-xl-12 wow fadeInUp" data-wow-delay="1.5s">
								<div class="table-responsive full-data">
									<table id="classTable" class="table table-responsive-md">
										<thead>
<tr>
@if(!is_null($class))
    <th>No</th>
...
<tr>
   ...
   class="btn btn-danger btn-sm btn-delete-student">
    Delete
        ...
        <a href="{{ route('student.reset.password', $student->id) }}"
  ...
  <div class="modal-dialog">
    <form action="{{ route('student.update', $student->id) }}" method="POST">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" name="nama" value="{{ $student->nama }}" class="form-control mb-2">
                <input type="text" name="npm" value="{{ $student->npm }}" class="form-control">
            </div>
...
<div class="modal fade"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('class.update',$c->id) }}"
                  method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="semester"
                            ...
                            <option value="Genap"
                            {{ $c->semester == 'Genap' ? 'selected' : '' }}>
                                Genap
                            </option>

                            <option value="Ganjil"
                            {{ $c->semester == 'Ganjil' ? 'selected' : '' }}>
                                Ganjil
                            </option>
...
<div class="modal fade" id="exampleModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-center">
    <div class="modal-content">
<form action="/class/store" method="POST" enctype="multipart/form-data">
    @csrf

      <div class="modal-header">
        <h5 class="modal-title">Detail Kelas Baru</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-xl-6">
			...
			<div class="mb-3">
    		<label class="form-label">Upload Mahasiswa (Excel)</label>
...
document.querySelectorAll('.btn-delete-class').forEach(button => {
    ...
    button.addEventListener('click', function(e){
        ...
        Swal.fire({
            title: 'Hapus Kelas?',
            text: 'Semua data mahasiswa dan presensi yang terkait bisa ikut terhapus.',
            icon: 'warning',
...
document.querySelectorAll('.btn-reset-password').forEach(button => {
    ...
    button.addEventListener('click', function(e){
        ...
        Swal.fire({
            ...
            text: 'Password mahasiswa akan diubah menjadi 12345678',
            icon: 'warning',
