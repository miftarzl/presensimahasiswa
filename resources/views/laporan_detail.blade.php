...
<head>
    ...
    <title> Detail Laporan - Presensi Online Mahasiswa</title>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    <small class="text-muted">Memenuhi (≥70%)</small>
                    <h2 class="text-success">{{ $memenuhi }}</h2>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    <small class="text-muted">Tidak Memenuhi</small>
                    <h2 class="text-danger">{{ $tidakMemenuhi }}</h2>
                </div>
...
<div class="modal fade"
    ...
    <div class="modal-dialog modal-lg">
     ...
     style="background:linear-gradient(135deg,#4F46E5,#6D5BFF);">
    ...
    <div
        class="progress-bar {{ $row['persentase'] >= 70 ? 'bg-success' : 'bg-danger' }}"
        role="progressbar"
        aria-valuenow="{{ $row['persentase'] }}"
        aria-valuemin="0"
        aria-valuemax="100"
